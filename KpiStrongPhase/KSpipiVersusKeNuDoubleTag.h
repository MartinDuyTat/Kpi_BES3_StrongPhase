...
/**
 * KSpipiVersusKeNuDoubleTag is a class for a BOSS algorithm
...
#ifndef KSPIPIPIPIVERSUSKENUDOUBLETAG
#define KSPIPIPIPIVERSUSKENUDOUBLETAG
...
class KSpipiVersusKeNuDoubleTag: public Algorithm {
  public: 
    /**
     * Default constructor for an algorithm where all necessary properties are declared
     */
    KSpipiVersusKeNuDoubleTag(const std::string& name, ISvcLocator* pSvcLocator);
    /**
     * Trivial destructor
     */
    ~KSpipiVersusKeNuDoubleTag();
    /**
