...
/**
 * KLKKVersusKpipi0DoubleTag is a class for a BOSS algorithm
 * It runs over \f$D^0\bar{D^0}\f$ data and saves all events with a double \f$D\to K_L^0K^+K^-\f$ vs \f$D^0\to K\pi\f$ tag
...
#ifndef KLKKPIPIVERSUSKPIPI0DOUBLETAG
#define KLKKPIPIVERSUSKPIPI0DOUBLETAG
...
class KLKKVersusKpipi0DoubleTag: public Algorithm {
  public: 
    /**
     * Default constructor for an algorithm where all necessary properties are declared
     */
    KLKKVersusKpipi0DoubleTag(const std::string& name, ISvcLocator* pSvcLocator);
    /**
     * Trivial destructor
     */
    ~KLKKVersusKpipi0DoubleTag();
    /**
