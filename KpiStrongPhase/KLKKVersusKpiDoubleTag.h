...
/**
 * KLKKVersusKpiDoubleTag is a class for a BOSS algorithm
...
#ifndef KLKKPIPIVERSUSKPIDOUBLETAG
#define KLKKPIPIVERSUSKPIDOUBLETAG
...
class KLKKVersusKpiDoubleTag: public Algorithm {
  public: 
    /**
     * Default constructor for an algorithm where all necessary properties are declared
     */
    KLKKVersusKpiDoubleTag(const std::string& name, ISvcLocator* pSvcLocator);
    /**
     * Trivial destructor
     */
    ~KLKKVersusKpiDoubleTag();
    /**
